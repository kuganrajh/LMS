...
export default class ViewMember extends Component {
    ...
    componentDidMount() {
        ...
        this.CRUDService.find(findRoute).then((result) => {
            ...
            //this.refs.batch_id.value=this.state.batches.items.find(batch=>batch.id== responseJson.batch_id).name;            
        });
                         ...
                         <div className="col-md-12">
                            ...
                            <div>
                                ...
                                <div className="form-group">
                                    ...
                                    <button  className={this.state.IsActive?"btn btn-success":"btn btn-danger"} >{this.state.IsActive?"Active":"Blocked"}</button>
                                </div>    
